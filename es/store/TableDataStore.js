...
var TableDataStore = function () {
  ...
  _createClass(TableDataStore, [{
    ...
    value: function filterText(targetVal, filterVal) {
      var cond = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Const.FILTER_COND_LIKE;
      ...
      this.filteredData = source.filter(function (row, r) {
        ...
        for (var key in filterObj) {
          ...
          switch (filterObj[key].type) {
            ...
            case Const.FILTER_TYPE.CUSTOM:
              {
                var cond = filterObj[key].props ? filterObj[key].props.cond : Const.FILTER_COND_LIKE;
            ...
            default:
              {
                ...
                var _cond = filterObj[key].props ? filterObj[key].props.cond : Const.FILTER_COND_LIKE;
    ...
    value: function _sort(arr) {
      ...
      arr.sort(function (a, b) {
        ...
        for (var i = 0; i < _this7.sortList.length; i++) {
          ...
          var isDesc = sortDetails.order.toLowerCase() === Const.SORT_DESC;
    ...
    value: function get() {
      ...
      var remote = typeof this.remote === 'function' ? this.remote(Const.REMOTE)[Const.REMOTE_PAGE] : this.remote;
