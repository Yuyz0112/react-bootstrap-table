...
var DateFilter = function (_Component) {
  ...
  _createClass(DateFilter, [{
    ...
    value: function onChangeComparator(event) {
      ...
      date = new Date(date);
      this.props.filterHandler({ date: date, comparator: comparator }, Const.FILTER_TYPE.DATE);
    }
  }, {
    ...
    value: function filter(event) {
      ...
      if (dateValue) {
        this.props.filterHandler({ date: new Date(dateValue), comparator: comparator }, Const.FILTER_TYPE.DATE);
      } else {
    ...
    value: function cleanFiltered() {
      ...
      this.props.filterHandler({ date: new Date(value), comparator: comparator }, Const.FILTER_TYPE.DATE);
    }
  }, {
    key: 'applyFilter',
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement('input', { ref: 'inputDate',
